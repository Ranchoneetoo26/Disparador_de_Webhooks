...
function checkFile(filePath) {
  ...
  if (
    filePath.includes("ReenviarWebhookInput.js") &&
  ...
  if (
    filePath.includes("ReenviarWebhookOutput.js") &&
  ...
  if (
    filePath.includes("ReenviarWebhookUseCase.js") &&
  ...
  if (
    filePath.includes("ReenviarWebhookController.js") &&
...
if (allOk) {
  ...
  console.log(
    "👉 Agora só testar no Insomnia/Postman pra confirmar os retornos (200, 400, 422)."
  );
} else {
  console.log(
